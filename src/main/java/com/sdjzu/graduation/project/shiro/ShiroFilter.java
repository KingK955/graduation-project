...
import com.sdjzu.graduation.project.common.utils.HttpContextUtils;
...
public class ShiroFilter extends AuthenticatingFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if(StringUtils.isBlank(token)){
            ...
            String json = new Gson().toJson(R.error(505, "invalid token"));
    ...
    protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e, ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            R r = R.error(505, throwable.getMessage());
